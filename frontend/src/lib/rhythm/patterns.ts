...
const A2: RhythmPattern = {
  id: 'a2',
  name: 'Viertel mit Pause',
  nameKey: 'rhythm.pat.a2',
  level: 'anfaenger',
  timeSignature: '4/4',
  bpm: 80,
...
const A4: RhythmPattern = {
  id: 'a4',
  name: 'Punktierte Halbe',
  nameKey: 'rhythm.pat.a4',
  level: 'anfaenger',
  timeSignature: '4/4',
  bpm: 76,
  beats: [q('1', 3), q('4')],
...
const F2: RhythmPattern = {
  id: 'f2',
  name: 'Synkope Einfach',
  nameKey: 'rhythm.pat.f2',
  level: 'fortgeschritten',
  timeSignature: '4/4',
  bpm: 88,
...
const F3: RhythmPattern = {
  id: 'f3',
  name: 'Punktierte Viertel',
  nameKey: 'rhythm.pat.f3',
  level: 'fortgeschritten',
  timeSignature: '4/4',
  bpm: 84,
...
const F4: RhythmPattern = {
  id: 'f4',
  name: 'Achtel-Achtel-Viertel',
  nameKey: 'rhythm.pat.f4',
  level: 'fortgeschritten',
  timeSignature: '4/4',
  bpm: 92,
...
const S1: RhythmPattern = {
  id: 's1',
  name: 'Sechzehntel-Gruppe',
  nameKey: 'rhythm.pat.s1',
  level: 'schwer',
  timeSignature: '4/4',
  bpm: 76,
  beats: [q('1', 0.25), q('1e', 0.25), q('1+', 0.25), q('1a', 0.25), q('2'), q('3'), q('4')],
};

const S2: RhythmPattern = {
  id: 's2',
  name: 'Gemischte Sechzehntel',
  nameKey: 'rhythm.pat.s2',
  level: 'schwer',
  timeSignature: '4/4',
  bpm: 72,
  beats: [q('1'), q('2', 0.25), q('2e', 0.25), q('2+', 0.25), q('2a', 0.25), q('3'), r('4')],
};

const S3: RhythmPattern = {
  id: 's3',
  name: 'Synkopen Komplex',
  nameKey: 'rhythm.pat.s3',
  level: 'schwer',
  timeSignature: '4/4',
  bpm: 80,
  beats: [
...
const S4: RhythmPattern = {
  id: 's4',
  name: 'Alla Breve',
  nameKey: 'rhythm.pat.s4',
  level: 'schwer',
  timeSignature: '4/4',
  bpm: 84,
  beats: [q('1', 0.5), q('1+', 0.5), q('2', 0.5), q('2+', 0.5), q('3', 1.5), q('4+', 0.5)],
};

// ── Exports ──

export const ALL_PATTERNS: RhythmPattern[] = [A1, A2, A3, A4, A5, F1, F2, F3, F4, S1, S2, S3, S4];
 ...
 */
export function computeExpectedOnsets(
  pattern: RhythmPattern,
): Array<{ beatIndex: number; expectedMs: number; label: string }> {
