...
echo "Native Tauri application build produced: $binary"
echo "Evidence boundary: packaged WebView SQLite CRUD is NOT executed headlessly; physical app launch remains required."
